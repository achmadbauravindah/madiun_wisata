            ...
            <div class="custom-card p-5">
                <div class="row">
                    ...
                    <form class="col-md-12 d-flex align-items-center pencarian" method="POST"
                        action="{{ route('manage-manager.searchInAdmin') }}">
                        @csrf
                        @method('post')
                ...
                <a class="cta-sm mt-3" href="{{ route('manager.register') }}">Daftarkan Manager</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $manager->nik }}</td>
                            <td>
                                <a href="{{ route('manage-manager.show', $manager->id) }}"
